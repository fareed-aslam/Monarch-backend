...
import {
  ...
  logout,
  onboard,
} from "../controllers/auth.controller.js"; // Importing the auth controller functions
import { protectRoute } from "../middlewares/auth.middleware.js"; // Importing the protectRoute middleware
