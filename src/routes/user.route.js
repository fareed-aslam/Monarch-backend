...
} from "../controllers/user.controller.js"; // Importing user controller functions
import { protectRoute } from "../middlewares/auth.middleware.js"; // Importing authentication middleware
